...
class TextSystem {
  ...
  TextStyle large(Color color) =>
      GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 16, color: color, fontWeight: FontWeight.bold));
  TextStyle veryLarge(Color color) => GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 18, color: color));
  TextStyle tooLarge(Color color) =>
      GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 24, color: color, fontWeight: FontWeight.w600));
  TextStyle extraLarge(Color color) =>
      GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 28, color: color, fontWeight: FontWeight.w600));
}
