...
class TextSystem {
  ...
  TextStyle normal(Color color) => GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14, color: color).copyWith(fontSize: 14, fontWeight: FontWeight.bold));
  TextStyle button(Color color, [bool smallText = false]) => GoogleFonts.montserrat(textStyle: TextStyle(fontSize: smallText ? 18 : 20, color: color, fontWeight: FontWeight.bold));
